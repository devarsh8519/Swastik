  ...
  return (
    <section className="py-20 md:py-32 px-6 my-20">
      <div className="max-w-5xl mx-auto">
        <div className="bg-gradient-to-br from-primary via-primary/95 to-primary/90 rounded-[3rem] p-12 md:p-20 text-center shadow-2xl border-2 border-primary-foreground/10">
